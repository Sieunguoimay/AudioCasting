...
private const val CHANNEL_ID = "audiocast_sender"
...
class AudioCaptureService : Service() {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        val serverName = intent?.getStringExtra("server_name") ?: "AudioCast Sender"
    ...
    private fun createNotificationChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val channel = NotificationChannel(
                ...
                description = "AudioCast audio broadcasting"
                setShowBadge(false)
            }
            val manager = getSystemService(NotificationManager::class.java)
    ...
    private fun buildNotification(serverName: String, clientCount: Int): Notification {
        ...
        return NotificationCompat.Builder(this, CHANNEL_ID)
            .setContentTitle("AudioCast Broadcasting")
