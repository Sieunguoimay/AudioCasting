...
import com.devicelink.audio.SystemAudioCapture
import com.devicelink.ui.MainScreen
import com.devicelink.ui.theme.DeviceLinkTheme
    ...
    private val mediaProjectionLauncher =
        registerForActivityResult(ActivityResultContracts.StartActivityForResult()) { result ->
            if (result.resultCode == RESULT_OK && result.data != null) {
                ...
                val serviceIntent = android.content.Intent(this, com.devicelink.service.AudioCaptureService::class.java).apply {
                    putExtra("server_name", pendingViewModel?.uiState?.value?.deviceName ?: "DeviceLink")
