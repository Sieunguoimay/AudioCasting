...
const SERVICE_TYPE: &str = "_devicelink._tcp.local.";

/// mDNS service advertiser for DeviceLink server discovery
...
impl Discovery {
    ...
    /// Register the DeviceLink service on the network
    pub fn register(
        &mut self,
        server_name: &str,
        port: u16,
        ...
        let host_name = hostname::get()
            ...
            .unwrap_or_else(|_| "devicelink".to_string());
